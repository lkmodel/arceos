...
// use axhal::{
//     mem::{PAGE_SIZE_4K, VirtAddr, virt_to_phys},
//     paging::{MappingFlags, PageSize, PageTable},
// };
// use axio::{Seek, SeekFrom};
// use core::ptr::copy_nonoverlapping;
//
// use crate::linux_env::mem_ext::MemBackend;
//
...
//         page_table
//             .unmap_region(self.vaddr, self.size(), false)
//             .unwrap();
//         self.pages.clear();
//     }
//
...
//         // unmap deleted pages
//         page_table
//             .unmap_region(self.vaddr, delete_size, false)
//             .unwrap();
//
...
//         // unmap deleted pages
//         page_table
//             .unmap_region(new_end, delete_size, false)
//             .unwrap();
//     }
//
...
//
//         page_table
//             .unmap_region(left_end, delete_size, false)
//             .unwrap();
//
//         right_area
//     }
