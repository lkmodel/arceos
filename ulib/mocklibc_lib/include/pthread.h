...
// int pthread_attr_getstack(const pthread_attr_t *__restrict, void **__restrict, size_t
// *__restrict); int pthread_attr_setstack(pthread_attr_t *, void *, size_t); int
// pthread_attr_getscope(const pthread_attr_t *__restrict, int *__restrict); int
// pthread_attr_setscope(pthread_attr_t *, int); int pthread_attr_getschedpolicy(const
// pthread_attr_t *__restrict, int *__restrict); int pthread_attr_setschedpolicy(pthread_attr_t *,
// int); int pthread_attr_getschedparam(const pthread_attr_t *__restrict, struct sched_param
// *__restrict); int pthread_attr_setschedparam(pthread_attr_t *__restrict, const struct sched_param
// *__restrict); int pthread_attr_getinheritsched(const pthread_attr_t *__restrict, int
// *__restrict); int pthread_attr_setinheritsched(pthread_attr_t *, int);
//
